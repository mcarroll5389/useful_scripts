...
$all_ADGroup_Data | Export-Csv -Path "$script_path\3-AD_ExportADGroups_All_Data.csv" -NoTypeInformation -Encoding UTF8
...
$filtered_ADGroup_Data | Export-Csv -Path "$script_path\2-AD_ExportADGroups_Filtered.csv" -NoTypeInformation -Encoding UTF8

$path_ADGroups = Import-Csv -Path "$script_path\3-AD_ExportADGroups_All_Data.csv" | Select-Object *,"Path"
...
$path_ADGroups_filtered | Export-Csv -Path "$script_path\1-AD_ExportADGroups_for_Import.csv" -NoTypeInformation -Encoding UTF8
